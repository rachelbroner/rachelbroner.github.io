<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttributesNameNumberCon.ascx.cs"
    Inherits="Controls_NameNumberCon" %>
    <p>
    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Add Attribute-Name Number Connection</asp:LinkButton>
</p>
    ...
    <table>
        <tr>
            ...
            <td style="text-align: right">
                 <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Name Number:"></asp:Label><br />
                 <asp:DropDownList ID="ddlNameNumber" SelectedValue='<%# Bind("nameNumber") %>' runat="server">
...
<p>
    <asp:GridView ID="gvAttributes" runat="server" AutoGenerateColumns="False" DataKeyNames="IDattribute,nameNumber"
        DataSourceID="AttributeNameNumberDataSource" Width="211px" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Name Number" SortExpression="nameNumber">
                <EditItemTemplate>
                    <asp:DropDownList ID="ddlNameNumber" SelectedValue='<%# Bind("nameNumber") %>' runat="server">
                        <asp:ListItem Value="1"></asp:ListItem>
                        <asp:ListItem>2</asp:ListItem>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("nameNumber") %>'></asp:Label>
                </ItemTemplate>
    ...
    <asp:AccessDataSource ID="AttributeNameNumberDataSource" runat="server" DataFile="~/App_Data/zodiac.mdb"
        DeleteCommand="DELETE FROM [attribute-namenumber] WHERE IDattribute=? AND nameNumber=?"
        SelectCommand="SELECT attribute.attribute as attribute, [attribute-namenumber].IDattribute as IDattribute , [attribute-namenumber].nameNumber as nameNumber FROM attribute INNER JOIN [attribute-namenumber] ON attribute.Id = [attribute-namenumber].IDattribute;"
        UpdateCommand="SELECT Id FROM [attribute]"
        >
        <DeleteParameters>
            <asp:Parameter Name="IDattribute" Type="Int32" />
            <asp:Parameter Name="nameNumber" Type="Int32" />
        </DeleteParameters>
